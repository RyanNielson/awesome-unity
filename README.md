...
* [cscore](https://assetstore.unity.com/packages/tools/integration/cscore-138254) - Provides helpers & patterns like events, injection logic, logging, file handling, Unity UI helpers, an immutable datastore and much more.
